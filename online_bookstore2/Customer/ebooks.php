...
<!DOCTYPE html>
    ...
    <body>
        ...
        <table>
            <tr>
                ...
                <td>
                    <div class="main">
                        <h1 style='text-align:center;'><i><u>My Ebooks</u></i></h1>
                        <?php
                        $sql = "SELECT * FROM eBooks NATURAL JOIN books where custID=".$custID;
                        $result = $conn->query($sql);
                        ...
                        ?>
                            <div class="page">
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <button class='btn' onClick="return viewPdf('<?php echo $row['bookID']; ?>');">View PDF</button>
                                        </td>
                                    </tr>
                                </table>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            window.location = "view_pdf.php?bookID="+BookID;
        }
    </script>
</html>
