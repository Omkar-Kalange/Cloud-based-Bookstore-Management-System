    ...
    <body>
        ...
        <table>
            <tr>
                ...
                <td>
                    <div class="main">
                        <h1 style='text-align:center;'><i><u>e-Books Available</u></i></h1>

                        <?php
                        $sql = "SELECT * FROM books where ebook_available='Y'";
                        $result = $conn->query($sql);
                        ...
                        ?>
                            ...
                            <div class="page">
                                ...
                                <button class='pdf' onClick="return viewPdf('<?php echo $row['bookID']; ?>');">View PDF</button>
                            </div>
                        <?php } ?>
                    </div>
                </td>
